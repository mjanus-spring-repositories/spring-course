package com.mjanus.springintegration.config;

import com.mjanus.springintegration.transformer.FileTransformer;
...
public class FileIntegrationConfiguration {
    ...
    IntegrationFlow fileIntegrationFlow(
        ...
        return IntegrationFlows.from(fileAdapter, config -> config.poller(Pollers.fixedRate(1000)))
